## /ng/{orgUuid}/orgtraces/filter/{traceFilterType}/listing (GET)
---
### Visibility
PUBLIC
### Description
...
| traceFilterType | Filter Type | vulnerabilityfiltertype | true | tags,severity,status,vulntype,servers,servers-environment,url,modules,security-standard,application-tags,sink,bugtracker-status,application-importance,application-language |
### Query Parameters
| Name | Description | Type | Required | Allowed Values |
| ----------- | ----------- | ----------- | ----------- | ----------- |
