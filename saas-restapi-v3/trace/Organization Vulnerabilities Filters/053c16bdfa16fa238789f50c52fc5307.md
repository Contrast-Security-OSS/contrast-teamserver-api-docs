...
| traceFilterType | Filter Type | vulnerabilityfiltertype | true | tags,severity,status,vulntype,servers,servers-environment,url,modules,security-standard,application-tags,sink,bugtracker-status |
### Query Parameters
| Name | Description | Type | Required | Allowed Values |
| ----------- | ----------- | ----------- | ----------- | ----------- |
