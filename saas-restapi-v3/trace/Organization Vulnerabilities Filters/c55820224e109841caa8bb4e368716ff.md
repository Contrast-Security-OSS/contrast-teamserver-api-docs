## /ng/{orgUuid}/orgtraces/filter (GET)
---
### Visibility
PUBLIC
### Description
...
| expand | Load additional data | list | false | events,notes,request,application,session_metadata,vulnerability_instances,skip_links |
| limit | Limit number of traces | integer | false | Integer |
| offset | Offset | integer | false | Integer |
| sort | Sort by | string | false | lastTimeSeen,status,title,application.name,severity,metadata |
