...
| Name | Description | Type | Required | Allowed Values |
| ----------- | ----------- | ----------- | ----------- | ----------- |
| expand | Load additional data | list | false | application,events,notes,request,server_environments,servers,session_metadata,sink,vulnerability_instances,skip_links |
