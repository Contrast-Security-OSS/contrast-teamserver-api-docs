## /ng/{orgUuid}/applications/{appId}/libraries/filter (GET)
---
### Visibility
PUBLIC
### Description
Get all the libraries for the current application by filters
### Auth
...
| appId | Application IDs | application | true | String |
### Query Parameters
| Name | Description | Type | Required | Allowed Values |
| ----------- | ----------- | ----------- | ----------- | ----------- |
